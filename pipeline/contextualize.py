...
async def _run_async(claim: str, context: str | None, language: str) -> dict[str, Any]:
    # Step 1: agentic tool loop — agent calls Data360 tools to research the claim
    loop_result = await _tool_loop(claim=claim, context=context, language=language)
